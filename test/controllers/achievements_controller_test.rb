...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { date_on: @achievement.date_on, name: @achievement.name, point_value: @achievement.point_value }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { date_on: @achievement.date_on, name: @achievement.name, point_value: @achievement.point_value }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
